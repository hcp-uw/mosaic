...
| [auth-server.md](auth-server.md) | Auth server: accounts, JWTs, endpoints, security model |
...
| [design-notes.md](design-notes.md) | Miscellaneous design notes and testing instructions |
